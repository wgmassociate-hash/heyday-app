...
6. reason은 반드시 "관찰된 행동"을 먼저 서술하고, 그로부터 자연스럽게 읽히는 해석을 덧붙이는 순서로 쓰세요. 상대의 속마음이나 의도를 단정하는 문장으로 시작하지 마세요.
   - 나쁜 예: "상대는 당신과 단둘이 있고 싶어합니다." (관찰 없이 마음부터 단정)
   - 좋은 예: "상대의 말에 이어 단둘이 식사하는 행동을 제안했습니다." (행동을 먼저 서술)
