...
⚠️ 「나」=본인(그대로 유지). 1:1 상대는 「상대방」, 단체톡 상대는 상대방A/B. JSON·리포트에 실명 금지.
...
### psychologySummary
- aiSummary보다 더 깊은 **관계 역학·애착·커뮤니케이션 패턴** 분석
- **6~8문장**, 구체적 대화 패턴·변화·의미를 풀어서 서술

### aiSummary
- **5~8문장**의 대화 종합 리포트
- 실제 대화에서 보인 말투·주제·분위기를 **구체적으로** 인용·설명
- 중고고등학생도 이해하기 쉬운 **친근한 한국어** (존댓말 OK)

### solution
- **5~7개** 실행 팁. 각 항목은 **2~3문장**으로 왜/어떻게까지 설명
- 줄바꿈(\\n)으로 항목 구분. 「①」「②」 번호 사용

### dominance
- **2~3문장**. 누가 주도하는지, 그게 관계에 어떤 의미인지 설명

### deepMetrics 해석 필드
- textMirroring.interpretation, replySpeedAsymmetry.interpretation 각 **3~5문장**
- evidence는 대화에서 직접 인용 3~4개

### criticalMoments
- psychologicalInsight: **2~4문장**. 인용구와 연결해 왜 중요한지 설명

### affectionTimeline
- 각 구간 insight: **1~2문장**, 그 기간 관계 온도 변화 설명
